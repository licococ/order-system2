...
const products = [
    ...
    { id: 4, name: "海鹽焦糖巴斯克乳酪蛋糕", price: 120, category: "常溫點心", img: "images/800x.jpg" },
    { id: 5, name: "法式經典香草可麗露 (2入)", price: 140, category: "法式塔類", img: "images/images (8).jpg" },
    { id: 6, name: "靜岡抹茶瑪德蓮 (3入)", price: 65, category: "常溫點心", img: "images/images (7).jpg" },
